...
<!-- The downloaded binary packages are in
	/var/folders/3m/fc4218wd5sg7_wwn0h6cz_kwfjshh8/T//RtmpcAryIa/downloaded_packages
Update old packages: 'assertthat', 'backports', 'boot', 'checkmate', 'clipr', 'cluster', 'data.table',
  'devtools', 'expm', 'fs', 'ggplot2', 'ggrepel', 'gtable', 'highr', 'igraph', 'MASS', 'Matrix', 'mgcv',
  'nlme', 'openssl', 'phangorn', 'pkgbuild', 'plotrix', 'processx', 'quadprog', 'rcmdcheck', 'RcppArmadillo',
  'remotes', 'rlang', 'rpart', 'survival', 'sys', 'testthat', 'usethis', 'xfun', 'xtable'
Update all/some/none? [a/s/n]:

  There are binary versions available but the source versions are later:
          binary source needs_compilation
ggrepel    0.8.0  0.8.1              TRUE
processx   3.3.0  3.3.1              TRUE
